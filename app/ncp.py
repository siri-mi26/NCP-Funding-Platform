...
from app.models import  Users, Students, Programs, Universities, Campuses, Grants, ProgramsByUniversity, UniversitiesFunding
...
def make_shell_context():
    ...
    return {'db': db, 'Users': Users, 'Students': Students, 'Programs': Programs, "Universities": Universities, "Campuses": Campuses, 'Grants':Grants, 'ProgramsByUniversity': ProgramsByUniversity, 'UniversitiesFunding': UniversitiesFunding}