...
class ProgramsModelView(ModelView):
    ...
    column_labels = {'Program_Name' : 'Program Name' , 'Program_Acronym' : 'Program Acronym' , 'Year' : 'Year' , 'Class_Code' : 'Class Code' , 'Project_Code' : 'Project Code' , 'ISEO_Code' : 'ISEO Code' , 'UWA_Mobility_Grant_Project_Grant_Number' : 'UWA Mobility Grant Project Grant Number' ,'UWA_Admin_Funding_Project_Grant_Number' :'UWA Admin Funding Project Grant Number' , 'Program_Type' : 'Program Type' , 'Project_Status' : 'Project Status' ,'CITIZENS_PR': 'Citizen\'s PR','SHORT_TERM_GRANT': 'Short Term Grant','SEMESTER_GRANT': 'Semester Grant','Funding_Acquittal_Date' : 'Funding Acquittal Date' , 'Project_Completion_Submission_Date' : 'Project Completion Submission Date' ,'Project_Completion_Report_Link' : 'Project Completion Report Link' , 'Refund_Utilisation_Commonwealth_Date' : 'Refund Utilisation Commonwealth Date' , 'Commonwealth_Refund_Invoice_Link' : 'Commonwealth Refund Invoice Link' , 'Statutory_Decleration_Date' : 'Statutory Decleration Date' ,'Statutory_Decleration_Link' : 'Statutory Decleration Link' , 'Original_Project_Schedule' : 'Original Project Schedule' , 'Deed_Of_Variation_One' : 'Deed Of Variation One' , 'Deed_Of_Variation_Two' : 'Deed Of Variation Two' , 'Deed_Of_Variation_Three' : 'Deed Of Variation Three' ,'Mobility_Grant_Funding_Received' : 'Mobility Grant Funding Received' , 'Mobility_Grant_Dollar_Size' : 'Mobility Grant Dollar Size' , 'Mobility_Grant_Funding_Utilised' : 'Mobility Grant Funding Utilised' , 'Mobility_Grant_Funding_Remaining' : 'Mobility Grant Funding Remaining' ,'Mobility_Grants_Received' : 'Mobility Grants Received' , 'Mobility_Grants_Utilised' : 'Mobility Grants Utilised' , 'Mobility_Grants_Remaining' : 'Mobility Grants Remaining' ,'Internship_Grant_Funding_Received' : 'Internship Grant Funding Received' , 'Internship_Grant_Dollar_Size' : 'Internship Grant Dollar Size' , 'Internship_Grant_Funding_Utilised' : 'Internship Grant Funding Utilised' , 'Internship_Grant_Funding_Remaining' : 'Internship Grant Funding Remaining' ,'Internship_Grants_Received' : 'Internship Grants Received' , 'Internship_Grants_Utilised' : 'Internship Grants Utilised' , 'Internship_Grants_Remaining' : 'Internship Grants Remaining' ,'Language_Grant_Funding_Received' : 'Language Grant Funding Received' , 'Language_Grant_Dollar_Size' : 'Language Grant Dollar Size' , 'Language_Grant_Funding_Utilised' : 'Language Grant Funding Utilised' , 'Language_Grant_Funding_Remaining' : 'Language Grant Funding Remaining' ,'Language_Grants_Received' : 'Language Grants Received' , 'Language_Grants_Utilised' : 'Language Grants Utilised' , 'Language_Grants_Remaining' : 'Language Grants Remaining' ,'Administration_Grant_Funding_Received' : 'Administration Grant Funding Received' , 'Administration_Grant_Dollar_Size' : 'Administration Grant Dollar Size' , 'Administration_Grant_Funding_Utilised' : 'Administration Grant Funding Utilised' , 'Administration_Grant_Funding_Remaining' : 'Administration Grant Funding Remaining' ,'Administration_Grants_Received' : 'Administration Grants Received' , 'Administration_Grants_Utilised' : 'Administration Grants Utilised' , 'Administration_Grants_Remaining' : 'Administration Grants Remaining' ,'Total_Grant_Funding_Received' : 'Total Grant Funding Received' , 'Total_Grant_Funding_Utilised' : 'Total Grant Funding Utilised' , 'Total_Grant_Funding_Remaining' : 'Total Grant Funding Remaining' ,'Total_Grants_Received' : 'Total Grants Received' , 'Total_Grants_Utilised' : 'Total Grants Utilised' , 'Total_Grants_Remaining' : 'Total Grants Remaining' , 'Notes' : 'Notes' ,'Program_Id':'Program ID'}

    
    column_descriptions = {'Program_Name' : 'Name of Grant Program',' Program_Acronym' : 'Grant Program Acronym',' Year' : 'Year Of Program',' Class_Code' : 'Class Code Of Program ',' Project_Code' : 'Class Code Of Project ',' ISEO_Code' : 'ISEO Code Of Program',' UWA_Mobility_Grant_Project_Grant_Number' : '','UWA_Admin_Funding_Project_Grant_Number' : '',' Program_Type' : 'Whether It Is Short-Term or Semester',' Project_Status' : '', 'CITIZENS_PR': 'Not previously Indonesian Citizen and/or Permanent Resident','SHORT_TERM_GRANT': 'Previously Received a Short Term Grant','SEMESTER_GRANT': 'Previously Received a Semester Grant', 'Eligibility_Ids' : 'A Unique Number For Each Eligibility Criteria ','Funding_Acquittal_Date' : '',' Project_Completion_Submission_Date' : 'Completion Date Of Project ','Project_Completion_Report_Link' : '',' Refund_Utilisation_Commonwealth_Date' : '',' Commonwealth_Refund_Invoice_Link' : '',' Statutory_Decleration_Date' : '','Statutory_Decleration_Link' : '',' Original_Project_Schedule' : '',' Deed_Of_Variation_One' : '',' Deed_Of_Variation_Two' : '',' Deed_Of_Variation_Three' : '','Mobility_Grant_Funding_Received' : 'Value Of Mobility Grant Funding Received',' Mobility_Grant_Dollar_Size' : 'Mobility Grant Value In Dollars ',' Mobility_Grant_Funding_Utilised' : 'Value Of Mobility Grant Funding Used ',' Mobility_Grant_Funding_Remaining' : 'Value Of Mobility Grant Funding Remaining ','Mobility_Grants_Received' : 'Number Of Mobility Grants Received',' Mobility_Grants_Utilised' : 'Number Of Mobility Grants Used',' Mobility_Grants_Remaining' : 'Number Of Mobility Grants Remaining',' Internship_Grant_Funding_Received' : 'Value Of Internship Grant Funding Received ',' Internship_Grant_Dollar_Size' : 'Internship Grant Value In Dollars',' Internship_Grant_Funding_Utilised' : 'Value Of Internship Grant Funding Used ',' Internship_Grant_Funding_Remaining' : 'Value Of Internship Grant Funding Remaining ','Internship_Grants_Received' : 'Number Of Internship Grants Received ',' Internship_Grants_Utilised' : 'Number Of Internship Grants Used ',' Internship_Grants_Remaining' : 'Number Of Internship Grants Remaining ','Language_Grant_Funding_Received' : 'Value Of Language Grant Funding Received ',' Language_Grant_Dollar_Size' : 'Language Grant Value In Dollars ',' Language_Grant_Funding_Utilised' : 'Value Of Language Grant Funding Used ',' Language_Grant_Funding_Remaining' : 'Value Of Language Grant Funding Remaining ','Language_Grants_Received' : 'Number Of Language Grants Received ',' Language_Grants_Utilised' : 'Number Of Language Grants Used',' Language_Grants_Remaining' : 'Number Of Language Grants Remaining ','Administration_Grant_Funding_Received' : 'Value Of Administration Grant Funding Received',' Administration_Grant_Dollar_Size' : 'Administration Grant Value In Dollars',' Administration_Grant_Funding_Utilised' : 'Value Of Administration Grant Funding Used',' Administration_Grant_Funding_Remaining' : 'Value Of Administration Grant Funding Remaining','Administration_Grants_Received' : 'Number Of Administration Grants Received ',' Administration_Grants_Utilised' : 'Number Of Administration Grants Used',' Administration_Grants_Remaining' : 'Number Of Administration Grants Remaining','Total_Grant_Funding_Received' : 'Value Of Total Grant Funding Received',' Total_Grant_Funding_Utilised' : 'Value Of Total Grant Funding Used',' Total_Grant_Funding_Remaining' : 'Value Of Total Grant Funding Remaining','Total_Grants_Received' : 'Number Of Total Grants Received',' Total_Grants_Utilised' : 'Number Of Total Grants Used',' Total_Grants_Remaining' : 'Number Of Total Grants Remaining',' Notes' : 'Extra Notes','Program_Id' : 'Program ID'}
